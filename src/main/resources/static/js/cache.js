...
layui.use(['form','jquery',"layer"],function() {
    ...
    function lockPage(){
        layer.open({
            title : false,
            type : 1,
            content : '<az class="admin-header-lock" id="lock-box">'+
                            '<az class="admin-header-lock-img"><img src="images/face.jpg" class="userAvatar"/></az>'+
                            '<az class="admin-header-lock-name" id="lockUserName">驊驊龔頾</az>'+
                            '<az class="input_btn">'+
    ...
    $(".functionSetting").click(function(){
        layer.open({
            ...
            area: ["380px", "280px"],
            type: "1",
            content :  '<az class="functionSrtting_box">'+
                            '<form class="layui-form">'+
                                '<az class="layui-form-item">'+
                                    '<label class="layui-form-label">开启Tab缓存</label>'+
                                    '<az class="layui-input-block">'+
                                        '<input type="checkbox" name="cache" lay-skin="switch" lay-text="开|关">'+
                                        '<az class="layui-word-aux">开启后刷新页面不关闭打开的Tab页</az>'+
                                    '</az>'+
                                '</az>'+
                                '<az class="layui-form-item">'+
                                    ...
                                    '<az class="layui-input-block">'+
                                        ...
                                        '<az class="layui-word-aux">开启后切换窗口刷新当前页面</az>'+
                                    '</az>'+
                                '</az>'+
                                '<az class="layui-form-item">'+
                                    ...
                                    '<az class="layui-input-block">'+
                                        ...
                                        '<az class="layui-word-aux">开启后不可同时多个地方登录</az>'+
                                    '</az>'+
                                '</az>'+
                                '<az class="layui-form-item skinBtn">'+
        ...
        layer.open({
            ...
            success : function(index, layero){
                ...
                $(".skins_box .layui-form-radio").on("click",function(){
                    var skinColor;
                    if($(this).find("az").text() == "橙色"){
                        skinColor = "orange";
                    }else if($(this).find("az").text() == "蓝色"){
                        skinColor = "blue";
                    }else if($(this).find("az").text() == "默认"){
                        skinColor = "";
                    }
                    if($(this).find("az").text() != "自定义"){
